...
package net.mcreator.arandommod.entity;
...
import net.mcreator.arandommod.ArandommodModElements;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@ArandommodModElements.ModElement.Tag
public class WraithwormEntity extends ArandommodModElements.ModElement {
	public static EntityType entity = null;
	public WraithwormEntity(ArandommodModElements instance) {
		super(instance, 2);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.5f, 0.4f)).build("wraithworm")
						.setRegistryName("wraithworm");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -14606561, -11714239, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("wraithworm_spawn_egg"));
	}

	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		boolean biomeCriteria = false;
		if (new ResourceLocation("arandommod:unchartedwaters").equals(event.getName()))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(entity, 9, 3, 5));
	}
			...
			RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelcustom_model(), 0.5f) {
					...
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("arandommod:textures/wraithworm.png");
					}
				};
			});
		}
	...
	private static class GlowingLayer<T extends Entity, M extends EntityModel<T>> extends LayerRenderer<T, M> {
		...
		public void render(MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn, T entitylivingbaseIn, float limbSwing,
			...
			IVertexBuilder ivertexbuilder = bufferIn.getBuffer(RenderType.getEyes(new ResourceLocation("arandommod:textures/wraithwormglow.png")));
